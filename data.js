export const articles = [
	{
		id: '1',
		title: 'Parsclick introduces dark mode and auto-merge pull request',
		excerpt:
			'Parsclick today announced a bunch of new features at its virtual Parsclick...',
		body:
			'Parsclick today announced a bunch of new features at its virtual Parsclick Universe conference including dark mode, auto-merge pull requests, and Enterprise Server 3.0. In the past couple of years, almost all major apps have rolled out a dark theme for its users, so why not Parsclick?',
	},
	{
		id: '2',
